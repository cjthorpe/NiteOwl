    ...
    >
      <div className="w-full max-w-sm text-center">
        ...
        {callbackStatus === 'success' && meta && (
          <SuccessState provider={provider as ActivityProvider} providerName={meta.name} brandColor={meta.brandColor} />
        )}
...
function SuccessState({
  ...
  return (
    <>
      ...
      <h1 className="mb-2 font-semibold" style={{ fontSize: 'var(--text-2xl)', color: 'var(--color-text)' }}>
