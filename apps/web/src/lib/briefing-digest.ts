 ...
 * matters" digest. This is the deterministic, dependency-free baseline: it runs
 * client-side over data already fetched for the briefing, needs no API key, and
 * is fully unit-testable.
 *
 * An optional LLM enhancement layer can later replace {@link buildBriefingDigest}
 * behind a feature flag, falling back to this heuristic whenever no model is
 * configured or the call fails. Keep this function pure so it stays a safe
 * fallback.
 */
